...
$restwell_legal_defaults = function_exists( 'restwell_get_accessibility_policy_page_defaults' )
	? restwell_get_accessibility_policy_page_defaults()
	: array();
...
if ( '' === $restwell_legal_heading ) {
	$restwell_legal_heading = (string) ( $restwell_legal_defaults['legal_heading'] ?? __( 'Restwell website accessibility', 'restwell-retreats' ) );
}
...
if ( '' === $restwell_legal_body && function_exists( 'restwell_get_accessibility_policy_content' ) ) {
	$restwell_legal_body = restwell_get_accessibility_policy_content();
}
