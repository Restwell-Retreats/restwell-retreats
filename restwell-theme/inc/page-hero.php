...
function restwell_theme_image_alt_map() {
	return array(
		...
		'bungalow/WR-1-LS.jpg'                                     => __( 'Level-access wet room with grab rails and a shower commode chair', 'restwell-retreats' ),
		'bungalow/WR-2-LS.jpg'                                     => __( 'Height-adjustable basin and Mira shower in the level-access wet room', 'restwell-retreats' ),
		'bungalow/wet-room-shower.png'                             => __( 'RAZ-AT tilt-in-space shower commode chair in the wet room', 'restwell-retreats' ),
		'bungalow/FD-1-LS.jpg'                                     => __( 'Porch outer doors open onto a level-threshold front door', 'restwell-retreats' ),
		'bungalow/H-1-LS.jpg'                                      => __( 'Amico GoLift 400 ceiling hoist on the bedroom track', 'restwell-retreats' ),
		'bungalow/BD2-2-LS.jpg'                                    => __( 'Two Accora profiling beds in the main bedroom', 'restwell-retreats' ),
		'bungalow/EQU-2-LS.jpg'                                    => __( 'Joerns Oxford Midi 180 mobile hoist, labelled on the boom', 'restwell-retreats' ),
		'bungalow/KT-1-LS.jpg'                                     => __( 'Kitchen with lowered wheel-under worksurface', 'restwell-retreats' ),
