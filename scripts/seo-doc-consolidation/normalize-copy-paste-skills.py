#!/usr/bin/env python3
"""Normalize COPY-PASTE skill refs to /skill-name only."""
...
paths = [
    ROOT / "restwell-theme" / "COPY-PASTE-PROCESS.md",
    ROOT / "restwell-theme" / "COPY-PASTE-PROMPTS.md",
]
...
for path in paths:
    ...
    if "/Users/elliesmith/.cursor/skills" in text:
        raise SystemExit(f"Still has absolute skill paths in {path}")
